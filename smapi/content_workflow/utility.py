...
class SvgValidator():
    ...
    """
    SVG_DTD = {'SVG 1.1 Basic': 'http://www.w3.org/Graphics/SVG/1.1/DTD/svg11-basic.dtd',
               'SVG 1.1': 'http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd'}
    ...
    def download_all_dtd_files(self, target_url):
        ...
        urlpath = urlopen(target_url)
        string = urlpath.read().decode('utf-8')

        pattern = re.compile('href=".*.zip"')
        filelist = pattern.findall(string)

        filename = filelist[-1][6:-5]
